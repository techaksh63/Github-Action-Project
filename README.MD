...
This project implements a **complete end-to-end CI/CD pipeline** using **GitHub Actions**, automating everything from compilation and security checks to builds docker image and push it to docker hub.
